...
public class CampeonatoSortearRodadasExceptionTest {
    private final List<Time> times;

    public CampeonatoSortearRodadasExceptionTest(List<Time> times) {
        this.times = times;
    }
    ...
    public void testSortearRodadasException() throws QtdPartidasInvalida, QtdTimesInvalida {
